...
import KiraUrl from '../assets/images/image-kira.jpg';
...
export const CARD_DATA:CardSpec[] = [
  {
    ...
    slogan: `I received a job offer mid-course, and the subjects I learned were current, if not more so, in the company I joined. I honestly feel I got every penny’s worth.`,
  ...
  },
  {
    ...
    slogan: `The team was very supportive and kept me motivated`,
  ...
  },
  {
    ...
    slogan: `An overall wonderful and rewarding experience`,
  ...
  },
  {
    ...
    slogan: `Awesome teaching support from TAs who did the bootcamp themselves. Getting guidance from them and learning from their experiences was easy.`,
  ...
  },
  {
    ...
    slogan: `Such a life-changing experience. Highly recommended!`,
